...
namespace ArrayTests
{
    public class ArrayTests
    {
        ...
        {
            // Arrange
            var initialCapacity = _array.Capacity;

            // Act
            while (_array.Count <= initialCapacity / 4)
            {
                _array.Add(0);
            }

            // Assert
            Assert.Equal(initialCapacity, _array.Capacity);
        }
        ...
        public void ShrinkArray_ShrinksCapacity_WhenCountIsLessThanQuarterOfCapacity()
        {
            ...
            // Assert
            Assert.Equal(initialCapacity / 2, _array.Capacity);
        }
